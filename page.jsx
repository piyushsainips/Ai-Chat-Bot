...
const userQuestion = "What is your return policy?";
const [userInput, setUserInput] = useState('');
const [userchatHistory, setChatHistory] = useState([]);
const [isLoading, setIsLoading] = useState(false);
const answer = matchQuestion(userQuestion);
console.log(answer);
        ...
        <div className="flex">
          ...
          {isLoading ? (
            ...
            <button onClick={handleUserInput}
             className="bg-blue-500 text-white p-2 rounded-r-lg hover:bg-blue-300">
              Ask
            </button>
          )}
        </div>
